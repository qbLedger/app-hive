#include "glyphs.h"
unsigned int const C_hive_logo_colors[] = {
  0x00000000,
  0x00ffffff,
};

unsigned char const C_hive_logo_bitmap[] = {
  0xc0, 0x0c, 0x98, 0x19, 0x98, 0x19, 0x3c, 0x33, 0x3c, 0x33, 0x7e, 0x66, 0x7e, 0x66, 0xff, 0xc0,
  0xff, 0xc0, 0x7e, 0x66, 0x7e, 0x66, 0x3c, 0x33, 0x3c, 0x33, 0x98, 0x19, 0x98, 0x19, 0xc0, 0x0c,
};
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_hive_logo = { GLYPH_hive_logo_WIDTH, GLYPH_hive_logo_HEIGHT, 1, C_hive_logo_colors, C_hive_logo_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
