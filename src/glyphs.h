        ...
        #define GLYPH_hive_logo_BPP 1
extern unsigned int const C_hive_logo_colors[];
extern unsigned char const C_hive_logo_bitmap[32];
#ifdef HAVE_BAGL
        #include "bagl.h"
        extern const bagl_icon_details_t C_hive_logo;
        #endif // GLYPH_hive_logo_BPP
        #endif // HAVE_BAGL
